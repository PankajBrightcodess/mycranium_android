                ...
                <thead>
                  <tr>
                   ...
                   <tr>
                    ...
                    <td colspan="1"><span><strong style="color:red;">COUNTRY</strong></span></td>
                     <td colspan="2" ><select class="form-control country" name="country_2" required> 
                          <option value="">---SELECT---</option>
                          <option value="India">India</option>
                          <?php 
                                if(!empty($country)){
                  ...
                  <tr>
                     ...
                     <td colspan="2" >                      
                      <input type="text" class="form-control" name="gstin"></td>
                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                    ...
                    <td colspan="1"><span><strong>INR 22,550.00</strong></span>
                      <input type="hidden" name="rate" value="22,550.00"></td>
                     <td colspan="1" ><span><strong>CS-CPB-10T</strong></span>
                    <input type="hidden" name="model_no" value="CS-CPB-10T"></td>
                    <td colspan="1" >                      
                      <select class="form-control" name="qty" id="qty">
                            <option value="">--SELECT--</option>
                            <option value="1">1</option>
                   ...
                   <tr>
                     ...
                     <td colspan="1" >
                     <input type="hidden" name="extralift" id="extralift" value="2000">                      
                     <select class="form-control" name="true_false" id="true_false" ><option>--SELECT--</option><option value="1">Yes</option><option value="0">No</option></select></td>
                     <td colspan="1" >                      
                      <select class="form-control" name="qty" id="qty">
                            <option value="">--SELECT--</option>
                            <option value="1">1</option>
                    ...
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="total">0.00</span></strong><input type="hidden" name="total_val" value=""></td>
                     <td colspan="2" ></td>
                  </tr>
                   <tr>
                     ...
                     <td colspan="1" >                      
                      <span><select class="form-control" name="true_false" id="true_false" ><option>--SELECT--</option><option value="1">Yes</option><option value="0">No</option></select></td>
                        ...
                        <input type="hidden" value="31000" name="column_e" id="column_e">
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="coumne_e_total">0.00</span></strong><input type="hidden" id="coumne_e_total_val" name="coumne_e_total_val"></td>
                     <td colspan="2" >CS-GT_CPB-10T<input type="hidden" name="traviling_moter_no_val" value="CS-GT_CPB-10T"></td>
                  </tr>
                   <tr>
                  ...
                  <tr>
                      <td colspan="6"><input type="submit" name="Preview" class="btn btn-sm btn-success" value="Preview"></td> 
                  </tr>
                </thead>
