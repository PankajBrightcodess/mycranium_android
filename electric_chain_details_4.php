                ...
                <thead>
                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                    ...
                    <td colspan="1"><span><strong id="rate">INR 112,500.00</strong></span>
                      <input type="hidden" name="rate" value="112500.00">
                    </td>
                     <td colspan="2" ><span><strong id="model_no">CS-CPB-5T</strong></span>
                   ...
                   <tr>
                     ...
                     <td colspan="1" >                      
                      <span><select class="form-control" name="true_false" id="true_false" ><option>--SELECT--</option><option value="1">Yes</option><option value="0">No</option></select></td>
                        ...
                        <input type="hidden" value="48500" name="column_e" id="column_e">
