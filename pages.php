...
<!-- Mirrored from designing-world.com/suha-v2.5.0/pages.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 12:08:37 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="page-content-wrapper py-3">
      <div class="container">
        <ul class="page-nav ps-0">
          ...
          <li><a href="intro.php">Intro Page<i class="lni lni-chevron-right"></i></a></li>
          <li class="nav-title">Shop Pages<span>10</span></li>
          ...
          <li><a href="sub-catagory.php">Sub Catagory<i class="lni lni-chevron-right"></i></a></li>
          ...
          <li><a href="flash-sale.php">Flash Sale<i class="lni lni-chevron-right"></i></a></li>
          <li><a href="featured-products.php">Featured Products<i class="lni lni-chevron-right"></i></a></li>
          <li><a href="my-order.php">Order Status<i class="lni lni-chevron-right"></i></a></li>
          <li class="nav-title">Vendor Pages<span>3</span></li>
          <li><a href="vendors.php">Vendors<i class="lni lni-chevron-right"></i></a></li>
          <li><a href="vendor-shop.php">Vendor Shop<i class="lni lni-chevron-right"></i></a></li>
          <li><a href="become-vendor.php">Become A Vendor<i class="lni lni-chevron-right"></i></a></li>
          <li class="nav-title">Cart &amp; Checkout<span>8</span></li>
          ...
          <li class="nav-title">Authentication Pages<span>7</span></li>
          ...
          <li><a href="forget-password-success.php">Forget Password Success<i class="lni lni-chevron-right"></i></a></li>
          <li class="nav-title">Blog Pages<span>3</span></li>
          ...
          <li class="nav-title">Chat &amp; Notifications<span>3</span></li>
          <li><a href="message.php">Message/Chat<i class="lni lni-chevron-right"></i></a></li>
          ...
          <li class="nav-title">Miscellaneous Pages<span>9</span></li>
...
<!-- Mirrored from designing-world.com/suha-v2.5.0/pages.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 12:08:45 GMT -->
</html>