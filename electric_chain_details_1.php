                ...
                <thead>
                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                    ...
                    <td colspan="1"><span><strong id="rate">INR 54,500.00</strong></span>
                      <input type="hidden" name="rate" value="54500.00">
                    </td>
                     <td colspan="2" ><strong id="model_no">CS-ECH-1T</strong></span>
