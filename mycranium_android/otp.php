...
<!-- Mirrored from designing-world.com/suha-v2.5.0/otp.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 12:08:48 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="otp-form mt-5 mx-4">
              <form action="otp-confirm.php" method="post">
                <div class="mb-4 d-flex">
                  ...
                  <input class="form-control ps-0" name="phone_no" id="phone_number" type="text" placeholder="Enter phone number">
                </div>
