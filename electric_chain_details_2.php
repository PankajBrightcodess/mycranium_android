                ...
                <thead>
                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                     ...
                     <td colspan="2" >                      
                      <span><strong id="model_no">CS-ECH-2T</strong></span>
                      <input type="hidden" name="model_no" value="CS-ECH-2T">
                    </td>
                    <td colspan="1"><span><strong id="rate">INR 60,500.00</strong></span>
                      <input type="hidden" name="rate" value="60500.00">
                    </td>
                     <td colspan="2" ></td>
                  </tr>
                   <tr>
                   ...
                   <tr>
                     ...
                     <td colspan="2" >                      
                      <span><select class="form-control" name="true_false" id="true_false" ><option>--SELECT--</option><option value="1">Yes</option><option value="0">No</option></select></td>
                        <input type="hidden" value="34500" name="column_e" id="column_e">
